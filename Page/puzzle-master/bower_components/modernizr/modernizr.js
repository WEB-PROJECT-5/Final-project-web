// Khởi tạo đối tượng Modernizr với các tham số là window, document và một biến n.
window.Modernizr = function(e, t, n) {
    
    // Hàm x để thiết lập cssText cho một phần tử
    function x(e) {
        f.cssText = e
    }

    // Hàm T để thêm các kiểu CSS vào phần tử
    function T(e, t) {
        return x(h.join(e + ";") + (t || ""))
    }

    // Hàm N để kiểm tra kiểu dữ liệu
    function N(e, t) {
        return typeof e === t
    }

    // Hàm C để kiểm tra một chuỗi có chứa một giá trị cụ thể hay không
    function C(e, t) {
        return !!~("" + e).indexOf(t)
    }

    // Hàm k để tìm kiếm trong một đối tượng
    function k(e, t, r) {
        for (var i in e) {
            var s = t[e[i]];
    ...
    // Hàm L để kiểm tra các thuộc tính của input
    function L() {
        i.input = function(n) {
    ...
    // Kiểm tra xem phương thức hasOwnProperty có tồn tại hay không
    ...
    // Kiểm tra khả năng hỗ trợ canvas
    d.canvas = function() {
        var e = t.createElement("canvas");
        return !!e.getContext && !!e.getContext("2d")
    };

    // Kiểm tra khả năng hỗ trợ cảm ứng
    d.touch = function() {
        var n;
    ...
    // Kiểm tra khả năng hỗ trợ audio
    d.audio = function() {
    ...
    // Kiểm tra khả năng hỗ trợ SVG
    d.svg = function() {
        return !!t.createElementNS && !!t.createElementNS(p.svg, "svg").createSVGRect
    };

    // Lặp qua các tính năng đã kiểm tra và lưu kết quả
    for (var A in d) S(d, A) && (b = A.toLowerCase(), i[b] = d[A](), g.push((i[b] ? "" : "no-") + b));
    
    // Kiểm tra các thuộc tính input
    return i.input || L(), i.addTest = function(e, t) {
        if (typeof e == "object")
    ...
    function(e, t) {
        ...
        e.html5 = y, g(t)
    }(this, t), i._version = r, i._prefixes = h, i.testStyles = w, o.className = o.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (s ? " js " + g.join(" ") : ""), i
} (this, this.document),
function(e, t, n) {
    function r(e) {
